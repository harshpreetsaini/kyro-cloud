...
export const GAME_DATABASE = [
  ...
  eg("the-finals","the-finals","THE FINALS","A free-to-play, team-based FPS with destructible environments.","Destructible environments in a team-based FPS.",null,"2023-12-07","Embark Studios","Embark Studios",[{id:4,name:"Action"}],4.1,null,["FPS","Multiplayer","Destruction","Free to Play"],"none",null,true),
  ...
  g("lost-ark-eg","lost-ark-eg","Lost Ark (Prime)","The Amazon-published action MMORPG.","Fast-paced action MMORPG.",null,"2022-02-11","Smilegate RPG","Amazon Games",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.1,null,["MMORPG","Action RPG","Free to Play","Co-op"],"full"),
