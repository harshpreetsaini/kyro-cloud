...
function g(id, slug, name, desc, short, appId, release, dev, pub, genres, rating, mc, tags, ctrl = "full", size = null, reqs = null, isFree = false) {
  return {
...
export const GAME_DATABASE = [
  ...
  // ── Shooters ──
  g("cs2","counter-strike-2","Counter-Strike 2","The next evolution of competitive FPS.","The next evolution of competitive FPS.","730","2023-09-27","Valve","Valve",[{id:4,name:"Action"}],4.3,83,["FPS","Competitive","Multiplayer","Tactical","Free to Play"],"none","30 GB",null,true),
  ...
  eg("genshin-impact","genshin-impact","Genshin Impact","A free-to-play open-world action RPG set in the fantasy world of Teyvat.","A free-to-play open-world action RPG.",null,"2020-09-28","miHoYo","miHoYo",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.3,null,["Open World","Action RPG","Free to Play","Co-op"],"full",null,true),
  ...
  ub("the-crew-motorfest","the-crew-motorfest","The Crew Motorfest","The ultimate open-world racing festival in Hawaii.","A racing festival in Hawaii.","2023-09-14","Ubisoft Ivory Tower","Ubisoft",[{id:4,name:"Action"},{id:28,name:"Simulation"}],4.0,null,["Racing","Open World","Multiplayer","Cars"],"full",null,"40 GB"),
  ub("star-wars-outlaws","star-wars-outlaws","Star Wars Outlaws","An open-world action-adventure set between Empire Strikes Back and Return of the Jedi.","An open-world Star Wars game.","2024-08-30","Massive Entertainment","Ubisoft",[{id:4,name:"Action"},{id:31,name:"Adventure"}],3.8,null,["Open World","Star Wars","Action","Adventure"],"full",null,"65 GB"),
  ...
  g("sea-of-thieves","sea-of-thieves","Sea of Thieves","A shared-world adventure game.","Live the pirate life.","1172650","2018-03-20","Rare","Xbox Game Studios",[{id:4,name:"Action"},{id:31,name:"Adventure"}],4.3,null,["Multiplayer","Pirates","Open World","Co-op"],"full"),
  ...
  g("warframe","warframe","Warframe","A free-to-play co-op action game.","Play as the Tenno.","230410","2013-03-25","Digital Extremes","Digital Extremes",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.2,null,["Free to Play","Co-op","Action","Sci-fi"],"full",null,null,true),
  g("lost-ark","lost-ark","Lost Ark","A free-to-play action MMORPG.","A Korean action MMORPG.","1599340","2022-02-11","Smilegate RPG","Amazon Games",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.1,null,["MMORPG","Action RPG","Free to Play","Co-op"],"full",null,null,true),
  g("new-world","new-world","New World","A free-to-play open-world MMORPG set in a supernatural 17th century.","A supernatural open-world MMORPG.","1063730","2021-09-28","Amazon Games","Amazon Games",[{id:4,name:"Action"},{id:5,name:"RPG"}],3.8,null,["MMORPG","Open World","Crafting","Multiplayer","Free to Play"],"full",null,null,true),
  ...
  g("dota-2","dota-2","Dota 2","The most-played MOBA on Steam.","A competitive team-based MOBA.","570","2013-07-09","Valve","Valve",[{id:4,name:"Action"},{id:12,name:"Strategy"}],4.2,null,["MOBA","Multiplayer","Competitive","Free to Play"],"none",null,null,true),
  g("tf2","team-fortress-2","Team Fortress 2","A team-based multiplayer shooter with nine distinct classes.","The class-based multiplayer shooter.","440","2007-10-10","Valve","Valve",[{id:4,name:"Action"}],4.3,null,["FPS","Multiplayer","Free to Play","Comedy"],"none",null,null,true),
  g("poe","path-of-exile","Path of Exile","A dark fantasy action RPG set in the world of Wraeclast.","A massive free-to-play ARPG.","238960","2013-10-23","Grinding Gear Games","Grinding Gear Games",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.4,null,["Action RPG","Free to Play","Loot","Co-op"],"full",null,null,true),
  ...
  g("war-thunder","war-thunder","War Thunder","The most comprehensive vehicle combat game ever made.","Fight in epic vehicle battles.","236390","2013-01-25","Gaijin Entertainment","Gaijin Entertainment",[{id:4,name:"Action"},{id:28,name:"Simulation"}],4.1,null,["Free to Play","Multiplayer","War","Military"],"full",null,null,true),
