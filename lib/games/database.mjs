...
function eg(id, slug, name, desc, short, epicSlug, release, dev, pub, genres, rating, mc, tags, ctrl = "full") {
  // Epic Games Store artwork format
  const cover = epicSlug ? `https://cdn1.epicgames.com/offer/${epicSlug}/VerticalCarouselThumbnail-1200x1600-6407b904e4b0aa7eb1b0a3e8c2bdab72.jpg` : null;
  const hero = epicSlug ? `https://cdn1.epicgames.com/offer/${epicSlug}/NewLaunchExtendedHeroImage-1920x1080-4e3e0b0e63f0a1e4e5ee60d44e2e8e4d.jpg` : null;
  return {
    id, slug, name, description: desc, shortDescription: short,
    coverImage: cover, heroImage: hero, screenshots: [],
    releaseDate: release, developer: dev, publisher: pub,
    genres, rating, metacritic: mc, platforms: ["PC"],
    providers: [{ id: `epic-${id}`, type: "steam", name: "Epic Games", launchMethod: "epic", availability: "available" }],
    availability: "available", installed: false, favorite: false,
    lastPlayedAt: null, playTime: 0, running: false,
    compatibility: "SUPPORTED", tags, controllerSupport: ctrl,
  };
...
function gg(id, slug, name, desc, short, gogId, release, dev, pub, genres, rating, mc, tags, ctrl = "full") {
  // GOG CDN artwork
  const cover = gogId ? `https://images.gog.com/${gogId}_library_600x900.jpg` : null;
  const hero = gogId ? `https://images.gog.com/${gogId}_bg_1920x1080.jpg` : null;
  return {
    id, slug, name, description: desc, shortDescription: short,
    coverImage: cover, heroImage: hero, screenshots: [],
    releaseDate: release, developer: dev, publisher: pub,
...
export const GAME_DATABASE = [
  ...
  eg("fortnite","fortnite","Fortnite","The free-to-play, ever-evolving multiplayer game.","The biggest battle royale in the world.","fortnite","2017-07-25","Epic Games","Epic Games",[{id:4,name:"Action"}],4.0,null,["Battle Royale","Shooter","Free to Play","Building"],"full"),
  eg("rocket-league-eg","rocket-league-eg","Rocket League","A high-powered hybrid of arcade-style soccer and vehicular mayhem.","Soccer meets rocket-powered cars.","rocket-league","2015-07-07","Psyonix","Epic Games",[{id:4,name:"Action"},{id:28,name:"Simulation"}],4.5,null,["Sports","Multiplayer","Competitive","Cars"],"full"),
  eg("fall-guys-eg","fall-guys-eg","Fall Guys","Dive into ridiculous challenges and mutating obstacle courses with up to 60 players.","A massive multiplayer party game.","fall-guys","2020-08-04","Mediatonic","Epic Games",[{id:4,name:"Action"}],4.0,null,["Party","Multiplayer","Competitive","Free to Play"],"full"),
  eg("genshin-impact","genshin-impact","Genshin Impact","A free-to-play open-world action RPG set in the fantasy world of Teyvat.","A free-to-play open-world action RPG.","genshin-impact","2020-09-28","miHoYo","miHoYo",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.3,null,["Open World","Action RPG","Free to Play","Co-op"],"full"),
  eg("the-finals","the-finals","THE FINALS","A free-to-play, team-based FPS with destructible environments.","Destructible environments in a team-based FPS.","the-finals","2023-12-07","Embark Studios","Embark Studios",[{id:4,name:"Action"}],4.1,null,["FPS","Multiplayer","Destruction","Free to Play"],"none"),
  eg("rumbleverse","rumbleverse","Rumbleverse","A free-to-play 40-player brawler battle royale.","A brawler battle royale.","rumbleverse","2022-08-11","Iron Galaxy","Epic Games",[{id:4,name:"Action"}],3.8,null,["Battle Royale","Fighting","Free to Play","Multiplayer"],"full"),
  eg("satisfactory","satisfactory","Satisfactory","An open-world factory-building game.","A 3D factory-building game.","satisfactory","2024-09-10","Coffee Stain Studios","Coffee Stain Publishing",[{id:12,name:"Strategy"},{id:28,name:"Simulation"}],4.7,null,["Automation","Building","Co-op","Base Building"],"none"),
  eg("saints-row","saints-row","Saints Row","The reboot of the beloved open-world crime saga.","The iconic open-world crime saga reborn.","saints-row","2022-08-23","Volition","Deep Silver",[{id:4,name:"Action"},{id:31,name:"Adventure"}],3.5,null,["Open World","Action","Crime","Story Rich"],"full"),
  eg("death-stranding","death-stranding","Death Stranding","From the creator of Metal Gear Solid, an open-world action game.","An open-world action game from Kojima Productions.","death-stranding","2019-11-08","Kojima Productions","505 Games",[{id:4,name:"Action"},{id:31,name:"Adventure"}],4.2,86,["Open World","Story Rich","Sci-fi","Atmospheric"],"full"),
  eg("titanfall-2","titanfall-2","Titanfall 2","Respawn Entertainment's acclaimed FPS with thrilling parkour and Titan combat.","A thrilling FPS with parkour and Titans.","titanfall-2","2016-10-28","Respawn Entertainment","Electronic Arts",[{id:4,name:"Action"}],4.7,94,["FPS","Action","Story Rich","Mechs"],"full"),
  eg("kingdom-come-2","kingdom-come-deliverance-ii","Kingdom Come: Deliverance II","A medieval open-world RPG set in 15th century Bohemia.","A medieval open-world RPG.","kingdom-come-deliverance-ii","2025-02-04","Warhorse Studios","Deep Silver",[{id:4,name:"Action"},{id:5,name:"RPG"},{id:31,name:"Adventure"}],4.3,null,["Medieval","Open World","Story Rich","RPG"],"full"),
  eg("jawns","jaws-of-jetmouth","Jaws of Jetmouth","An arcade-style underwater combat game.","Underwater combat action.",null,"2024-10-15","Nighthawk Interactive","Nighthawk Interactive",[{id:4,name:"Action"}],null,null,["Arcade","Action","Underwater"],"full"),

  // ── GOG (DRM-Free) ──
  gg("witcher-3-gog","the-witcher-3-wild-hunt-gog","The Witcher 3: Wild Hunt (GOG)","An open-world fantasy RPG.","The definitive RPG experience.","witcher-3-wild-hunt","2015-05-18","CD PROJEKT RED","CD PROJEKT",[{id:4,name:"Action"},{id:5,name:"RPG"},{id:31,name:"Adventure"}],4.8,93,["Open World","Story Rich","Fantasy","RPG"],"full"),
  gg("baldurs-gate-3-gog","baldurs-gate-3-gog","Baldur's Gate 3 (GOG)","Gather your party and return to the Forgotten Realms.","An epic RPG from Larian.","baldurs-gate-3","2023-08-03","Larian Studios","Larian Studios",[{id:5,name:"RPG"},{id:31,name:"Adventure"},{id:12,name:"Strategy"}],4.9,96,["Turn-Based","Story Rich","Co-op","Fantasy"],"full"),
  gg("cyberpunk-2077-gog","cyberpunk-2077-gog","Cyberpunk 2077 (GOG)","An open-world action-adventure RPG set in Night City.","A neon-soaked RPG.","cyberpunk-2077","2020-12-10","CD PROJEKT RED","CD PROJEKT",[{id:4,name:"Action"},{id:5,name:"RPG"},{id:31,name:"Adventure"}],4.2,86,["Open World","Cyberpunk","Story Rich","FPS"],"full"),
  gg("hades-gog","hades-gog","Hades (GOG)","A rogue-like dungeon crawler from Supergiant Games.","Defy the god of the dead.","hades","2020-09-17","Supergiant Games","Supergiant Games",[{id:4,name:"Action"},{id:31,name:"Adventure"}],4.8,93,["Roguelike","Action","Indie","Mythology"],"full"),
  gg("disco-elysium-gog","disco-elysium-gog","Disco Elysium (GOG)","A revolutionary role-playing game.","A groundbreaking RPG.","disco-elysium","2019-10-15","ZA/UM","ZA/UM",[{id:5,name:"RPG"},{id:31,name:"Adventure"}],4.6,91,["RPG","Detective","Story Rich","Indie"],"none"),
  gg("divinity-2-gog","divinity-original-sin-2","Divinity: Original Sin 2 (GOG)","A party-based RPG with unprecedented freedom.","A party-based RPG with deep storytelling.","divinity-original-sin-2","2017-09-14","Larian Studios","Larian Studios",[{id:5,name:"RPG"},{id:12,name:"Strategy"}],4.7,93,["RPG","Co-op","Turn-Based","Story Rich"],"full"),
  gg("stardew-valley-gog","stardew-valley-gog","Stardew Valley (GOG)","Build your dream farm.","A farming RPG.","stardew-valley","2016-02-26","ConcernedApe","ConcernedApe",[{id:12,name:"Strategy"},{id:28,name:"Simulation"},{id:31,name:"Adventure"}],4.9,89,["Farming Sim","Pixel Graphics","RPG","Co-op"],"full"),
