...
export const GAME_DATABASE = [
  ...
  ub("rainbow-six-siege","rainbow-six-siege","Tom Clancy's Rainbow Six Siege","A tactical 5v5 multiplayer FPS.","A tactical team-based FPS.","2015-12-01","Ubisoft Montreal","Ubisoft",[{id:4,name:"Action"}],4.2,79,["FPS","Tactical","Multiplayer","Competitive"],"none"),
