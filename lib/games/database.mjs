...
export const GAME_DATABASE = [
  ...
  g("warframe-linux","warframe","Warframe","A fast-paced sci-fi shooter looter, with native Linux support.","A co-op sci-fi action shooter.","230410","2013-03-25","Digital Extremes","Digital Extremes",[{id:4,name:"Action"},{id:5,name:"RPG"}],4.2,null,["Free to Play","Looter Shooter","Co-op","Sci-fi","Linux"],"full",null,null,true,true),
